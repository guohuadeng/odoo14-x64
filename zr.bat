...
ping -n 1 127.0.0.1>nul
%CD%\runtime\pgsql\bin\pg_ctl -D d:\pjweb\o14.odooapp.cn\z\pg -l %CD%\runtime\pgsql\logfile start
ping -n 1 127.0.0.1>nul
%CD%\runtime\python3\python3 %CD%\source\odoo-bin -c %CD%\odoo_app.conf --update=""
